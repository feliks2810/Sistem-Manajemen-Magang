        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex items-center gap-4">
                    @if($pembimbing->user->avatar)
                        <img src="{{ Storage::url($pembimbing->user->avatar) }}" alt="Avatar" class="h-16 w-16 shrink-0 rounded-full object-cover ring-2 ring-slate-100 shadow-sm">
                    @else
